...
class Parser
{
    ...
    public function parseContent($file)
    {
        ...
        $edi_content = $this->removeExtraSpacesRecursively($edi_content);
        return $edi_content;
    }

    public function removeExtraSpaces($value)
    {
        $value = trim(@$value);
    ...
    public function removeExtraSpacesRecursively($array)
    {
        foreach ($array as $key => $value) {
            if (is_array($value)) {
                $array[$key] = $this->removeExtraSpacesRecursively($value);
            } else {
                $array[$key] = $this->removeExtraSpaces($value);
            }
        }
        return $array;
    }
